...
public class OrderTypeRESTController {
	...
	public ResponseEntity<HttpStatus> deleteOrderType(@PathVariable long orderTypeId)  //delete order
    {
	...
	public OrderType getOrderType(@PathVariable long orderTypeId) //get orders
	 {
	 ...
	 @PostMapping( )
	public OrderType insertOrderType(@RequestBody OrderType orderType) //insert order
	{
		 return orderTypeRepository.save(orderType);
	}

	 @PutMapping ( )
	public OrderType updateOrderType(@RequestBody OrderType orderType) //update order
	{
		 return orderTypeRepository.save(orderType);
	}
}